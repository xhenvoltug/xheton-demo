...
import { Plus, Minus, Search, Trash2, Save, X } from 'lucide-react';
import toast from 'react-hot-toast';

const mockProducts = [
  { id: 'P001', name: 'Laptop Pro 15"', price: 1299.99, stock: 45 },
  { id: 'P002', name: 'Wireless Mouse', price: 29.99, stock: 120 },
  { id: 'P003', name: 'USB-C Cable', price: 15.99, stock: 200 },
  { id: 'P004', name: 'Monitor 27"', price: 349.99, stock: 30 },
  { id: 'P005', name: 'Keyboard Mechanical', price: 89.99, stock: 67 },
];

const mockCustomers = [
  { id: 'C001', name: 'Acme Corporation' },
  { id: 'C002', name: 'TechStart Inc' },
  { id: 'C003', name: 'Global Traders' },
  { id: 'C004', name: 'Metro Solutions' },
];
